...
local UPDATE_GH_FILE    = "PCStats_v1.1.4.lua"   -- <- путь к .lua файлу скрипта внутри репозитория
local UPDATE_GH_VERFILE = "version.txt"          -- <- необязательный лёгкий файл с одной строкой-версией

local SCRIPT_VERSION = "1.1.4" -- должно совпадать с script_version() в начале файла
...
imgui.OnFrame(
    ...
    function(self)
        ...
        do
            ...
            local finShiftPx = S(330) * St._finShiftAnim -- ширина панели (320) + отступ (10)
