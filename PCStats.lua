...
function Updater.doDownload()
    ...
    if Updater.dlState == "downloading" then
        pcall(sampAddChatMessage, "{FFD700}\x5b\x50\x43\x20\x53\x74\x61\x74\x73\x5d\x20\xce\xe1\xed\xee\xe2\xeb\xe5\xed\xe8\xe5\x20\xf3\xe6\xe5\x20\xe8\xe4\xb8\xf2\x2c\x20\xef\xee\xe4\xee\xe6\xe4\xe8\xf2\xe5\x2e\xe5\xe5\xe5", -1)
        return
    end
    if not Updater.isConfigured() then
        Updater.status  = "error"
