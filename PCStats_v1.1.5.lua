...
-- проверяем, что тело ответа похоже на настоящий .lua скрипт, а не на
-- страницу ошибки GitHub (404 / HTML) - иначе можно затереть рабочий
-- файл мусором
...
-- атомарная запись: сначала во временный файл, потом переименование на
-- место рабочего - если скачивание/запись прервётся на середине,
-- текущий рабочий скрипт не пострадает
